...
<head>
    ...
    <link rel="stylesheet" href="css/registrar_docentes_style.css">
</head>
<body>
<div class="container py-5">
    <div class="main-card">
        <div class="card mb-4 welcome-card">
            <h2 class="mb-1 welcome-title"><i class="bi bi-person-badge me-2"></i> Gestión de Docentes</h2>
            <p class="mb-0 welcome-subtitle">Registra, edita y elimina docentes del sistema.</p>
        </div>
