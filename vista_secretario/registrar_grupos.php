...
<head>
    ...
    <link rel="stylesheet" href="css/registrar_grupos_style.css">
</head>
<body>
<div class="container py-5">
    <div class="main-card">
        <div class="card mb-4 welcome-card">
            <h2 class="mb-1 welcome-title"><i class="bi bi-collection me-2"></i> Gestión de Grupos</h2>
            <p class="mb-0 welcome-subtitle">Registra, edita y elimina grupos escolares.</p>
        </div>
